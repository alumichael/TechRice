...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @BindView(R.id.barrier_social_btn)
    Barrier mBarrierSocialBtn;
    ...
    private void sendLoginData(){
        ...
        LoginPost loginPost =new LoginPost(mPhoneEdt.getText().toString(),
                mPasswordEdt.getText().toString());
        Log.i("LoginObj", loginPost.toString());

        sentNetworkRequest(loginPost);
    }

    private  void sentNetworkRequest(LoginPost loginPost){
        try {

            //get client and call object for request
            ApiInterface client = ServiceGenerator.createService(ApiInterface.class);

            Call<LoginResponseHead> call = client.login(loginPost);
