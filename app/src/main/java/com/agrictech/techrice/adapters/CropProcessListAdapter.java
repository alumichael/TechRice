...
public class CropProcessListAdapter extends RecyclerView.Adapter<CropProcessListAdapter.MyViewHolder> {

private Context context;
private List<ProcessResponseData> cardList;

public CropProcessListAdapter(Context context, List<ProcessResponseData> cardList) {
